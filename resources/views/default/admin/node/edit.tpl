...
<div class="content-wrapper">
 ...
 <fieldset class="col-sm-6">
                                    <legend>线路VIP等级</legend>
                                    <div class="form-group">
                                        <label for="vip_level" class="col-sm-3 control-label">VIP LEVEL</label>

                                        <div class="col-sm-9">
                                            <input class="form-control" id="vip_level" type="number" value="{$node->vip_level}">
                                        </div>
                                    </div>
                                </fieldset>
